...
def getScalars():
    ...
    pzvals.append(zvals[223]) # 1MhZ
    pzvals.append(zvals[217]) # BCM4A
    pzvals.append(zvals[160]) # pTRIG1
    pzvals.append(zvals[163]) # pTRIG4
    pzvals.append(zvals[165]) # pTRIG6
...
def main():
    ...
    while True:
        ...
        if diff>0 :
          ...
          current = ((zvals2[1]-zvals[1])/time1+2994.0)/13650.
          t1rate=  (zvals2[2]-zvals[2])/time1/1000.
          t4rate=  (zvals2[3]-zvals[3])/time1/1000.
          t6rate=  (zvals2[4]-zvals[4])/time1/1000.
          acc_rate = t1rate*t4rate*50/1000./1000.
          livetime = 1-(t6rate*0.220/(1+t6rate*0.220))
          charge = 0
          ...
          print('SHMS T1 rate kHz = {0:10.5f} , HMS T1 Rate kHz = {1:10.5f}'.format(t1rate,t4rate))
          print('COIN T6 Rate Hz = {0:10.5f}, COIN Acc Rate Hz = {1:10.5f}, LT =  {2:5.3f}'.format(t6rate*1000,acc_rate*1000,livetime))
