...
void replay_hodo_coin_NPS_HMS(int RunNumber=0, int MaxEvent=0, int FirstEvent = 1, int MaxSegment = 1, int FirstSegment = 0, const char* fname_prefix = "nps_coin")
{
  ...
  // Define DEF-file+
  analyzer->SetOdefFile("DEF-files/NPS/NPS_hodo.def"); //FIXME: CHANGE
  // Define cuts file
