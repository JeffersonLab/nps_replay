void eel108_replay_mkj(Int_t RunNumber=0, Int_t MaxEvent=0)
{
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/mkj_nps_%d_%d.root";
  ...
  gHcParms->Load("PARAM/mkj_temp.param");
  ...
  analyzer->PrintReport("TEMPLATES/NPS/NPS.template",
			Form("REPORT_OUTPUT/NPS/eel108/mkj_eel108_report_%d_%d.report", RunNumber, MaxEvent));
