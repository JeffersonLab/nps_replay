// A TEST TO GENERATE A FILE WITH ALL THE PEDESTALS

void cosmics_replay_wassim(Int_t RunNumber=0, Int_t MaxEvent=0)
{
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/root_files_wassim/nps_%d_wassim.root";
  ...
  gHcParms->Load("PARAM/wassim_test.param");
